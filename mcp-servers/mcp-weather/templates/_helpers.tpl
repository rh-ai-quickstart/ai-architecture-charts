...
helm.sh/chart: {{ include "mcp-weather.chart" . }}
...
*/}}
{{- define "mcp-weather.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "mcp-weather.fullname" .) .Values.serviceAccount.name }}
{{- else }}
